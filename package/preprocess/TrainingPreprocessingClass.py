...
from package.logging.LoggerPathsConstantClass import data_preprocess_for_training_logs
from package.logging.LoggingClass import Logger
from package.preprocess.PreprocessingClass import Preprocessing
from package.utils.FolderConstantsClass import training_database_folder, training_input_filename


class TrainingPreprocessing(Preprocessing):

    def __init__(self):
        self.preprocess_logger = Logger(data_preprocess_for_training_logs)
